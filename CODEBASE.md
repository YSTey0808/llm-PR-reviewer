...
| [tests/fixtures/*.diff](tests/fixtures/) | Hand-written diff *shapes*: `binary_only`, `chmod_exec`, `new_exec`, `lockfile_evil`, `lockfile_clean`, `injection_in_sample`, `dist_only`. |
